const Board = () => {
  ...
  return (
    <div>
      ...
      <div id="info">
        <h1>Tic-Tac-Toe</h1>
        <div id="turn" display="inline">
          {!winner && <h2 id="x" className={playerTurn}>Player X</h2>}
          {!winner && <h2 id="o" className={playerTurn}>Player O</h2>}
          {winner && <h1 className="winner">{status}</h1>}
        </div>
      </div>
